...
--
-- Gazdă: 127.0.0.1
-- Timp de generare: iun. 19, 2019 la 03:35 PM
...
(7, 'Donează împreună cu noi', 'Împreuna putem ajuta.\r\nAlătură-te la o noua campanie de donare sanguină ce privește toți pacienții noștri.\r\nCampania se desfășoară în cadrul centrului sanitar județean Slatina.', '2019-09-15', 'Slatina', 'drops.jpg', 1, 0),
(8, 'Împarte zâmbete', 'Împarte zâmbete este campania de donare sanguină care se desfășoara la Teatrul Marin Sorescu cu scopul de a ajuta cât mai multe persoane care au nevoie de produse sanguine, de a le împărții speranță și puțină bucurie', '2019-07-10', 'Teatrul Național ,Craiova', 'drops-of-life.jpg', 0, 0),
(9, 'Dăruiește și tu', 'Alătură-te la o noua campanie de donare sanguină ce privește toți pacienții noștri.\r\nCampania se desfășoară în cadrul centrului nostru.', '2019-10-10', 'Centrul BloodBank', 'drops.jpg', 1, 0),
(10, 'Sângele reprezintă un dar neprețuit!', 'Dăruiește și tu alături de echipa noastră și oferă o șansă la viată mai multor persoane', '2019-11-01', 'Centrul BloodBank', 'drops-of-life.jpg', 1, 10);
...
(1, '2960820284541', 'OT', 677288, 'Slatina', 'Olt', 'Aleea viorelelor, GA5A, et.8, ap.34', '2019-06-18 15:26:59'),
...
(9, '1720506123123', 'OT', 456985, 'Slatina', 'Olt', 'str.Aleea Viorelelor, bl.GA5A, et.8', '2019-06-18 16:20:30'),
...
(15, '1940216258963', 'OT', 123654, 'Slatina', 'Olt', 'str.Aleea Viorelelor, bl.GA5A, et.8', '2019-06-18 16:45:09'),
(16, '1831021525469', 'OT', 123456, 'Slatina', 'Olt', 'str.Crinului , bl.2, et.1, ap.3', '2019-06-18 16:45:09'),
...
(24, '1700229584631', 'OT', 854631, 'Slatina', 'Olt', 'str. Arinului, nr.27', '2019-06-18 18:13:20'),
...
(37, '2940121789987', 'DJ', 168861, 'Craiova', 'Dolj', 'str.Lacramioarei, nr.3, et.1, ap 1', '2019-06-18 17:33:01'),
...
(40, '2941018123456', 'DJ', 685622, 'Craiova', 'Dolj', 'str.Lacramioarei, nr1, et2, ap 4', '2019-06-18 17:33:01'),
...
(2, 'Iancu', 'octavian', 'Hello', 'iancu_octavian@yahoo.com', 1, '2019-06-09 00:00:00'),
(3, 'Dragan', 'Diana', 'Hello', 'dragan_diana96@yahoo.com', 0, '2019-06-19 00:00:00'),
(4, 'Popescu', 'Ana', 'footer', 'ana_popescu@yahoo.com', 1, '2019-06-02 00:00:00');
...
(12, 'Diana-Andreea', 'Dragan', 'dyusk_96@yahoo.com', '1996-08-20', 760373781, 'f', '+', 'AB', 'Nevoie urgenta de sange....', 'Da', '2019-04-03 10:48:16', 1),
...
(15, 'Diana', 'Popescu', 'dyusk_96@yahoo.com', '1996-08-20', 760373781, 'f', '+', 'AB', 'Aplazie medulară, până în momentul operației trebuie să facă transfuzii sanguine zilnice', 'Da', '2019-06-18 22:00:52', 0),
(16, 'Elena', 'Popa', 'dyusk_96@yahoo.com', '1976-06-05', 760373781, 'f', '+', 'B', 'Nevoie de transfuzii sanguine zilnice.', 'Da', '2019-06-18 22:02:12', 0),
...
(4, 'Spitalul Judetean Slatina', 'sjSlatina@yahoo.com', 770506027, 10, '+', 'AB', 'Stocuri insuficiente pentru operatiile medicale.', '2019-04-03 07:52:38', 1),
...
(10, 'Spitalul Judetean Slatina', 'sjSlatina@yahoo.com', 760000000, 20, '-', 'AB', 'Stocuri insuficiente pentru operatiile medicale', '2019-06-19 07:20:42', 0),
(11, 'Spitalul Judetean Slatina', 'sjSlatina@yahoo.com', 760000000, 23, '-', 'B', 'Stocuri insuficiente pentru operatiile medicale', '2019-06-19 07:20:42', 0);
...
--
-- Structură tabel pentru tabel `stare_pacient`
--

CREATE TABLE `stare_pacient` (
  `id` int(10) NOT NULL,
  `stare` varchar(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Eliminarea datelor din tabel `stare_pacient`
--

INSERT INTO `stare_pacient` (`id`, `stare`) VALUES
(0, 'inactiv'),
(1, 'activ');
