            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                    <div class="wb-traffic-inner notika-shadow sm-res-mg-t-30 tb-res-mg-t-30">
                        <div class="website-traffic-ctn">
                            ...
                            <h4>0 + : <span class="counter">50</span></h4>
                            <h4>0 - : <span class="counter">50</span></h4>
                        </div>
                    ...
                    <div class="wb-traffic-inner notika-shadow sm-res-mg-t-30 tb-res-mg-t-30">
                        <div class="website-traffic-ctn">
                            ...
                            <h4>Cantitate cu rh + : <span class="counter">50</span></h4>
                            <h4>Cantitate cu rh - : <span class="counter">50</span></h4>
                        </div>
              ...
              <!--   <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                    <div class="wb-traffic-inner notika-shadow sm-res-mg-t-30 tb-res-mg-t-30">
                        ...
                        <div class="sparkline-bar-stats2">15,4</div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
