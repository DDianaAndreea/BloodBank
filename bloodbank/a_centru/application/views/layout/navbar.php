            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <ul class="nav nav-tabs notika-menu-wrap menu-it-icon-pro">
                        ...
                        <li><a data-toggle="tab" href="#tabele"><i class="fa fa-table"></i> Tabele</a>
                        </li>
                        <li><a data-toggle="tab" href="#campanii"><i class="fa fa-users"></i> Campanii</a>
                        </li>
                    ...
                    <div class="tab-content custom-menu-content">
                        ...
                        <div id="tabele" class="tab-pane notika-tab-menu-bg animated flipInX">
                            <ul class="notika-main-menu-dropdown">
                                ...
                                <li><a href="<?php echo base_url('cazuri')?>">Cazuri publicate</a>
                                </li>
                            </ul>
                        </div>
                        <div id="campanii" class="tab-pane notika-tab-menu-bg animated flipInX">
                            <ul class="notika-main-menu-dropdown">
