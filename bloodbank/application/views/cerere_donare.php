      ...
      <div class="container">
        <div class="row">
          <div class="col-md-4 element-animate">
            <img src='<?php echo base_url("assets/images/donez.jpg") ?>' class="img-fluid mb-4" alt="Image placeholder">
          </div>
          ...
          <div class="col-md-5 element-animate">
            ...
            <br><br>
            <a href='<?php echo base_url("chestionar_d") ?>' class="btn btn-success" >Vreau să donez!</a>
